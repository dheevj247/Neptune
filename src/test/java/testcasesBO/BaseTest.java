...
public class BaseTest implements AutoContants
{
	...
	/*------------------------------- Login into the Application -------------------------------*/
	  ...
	  { 
		  ...
		  usertype = DEFAULT_Branch; 
		  username = DEFAULT_BO_USERNAME; 
		  password = DEFAULT_BO_PASSWORD; 
		  driver.get(PropertyFileLib.getValue(CON_PROP_PATH,"testurlBO")); 
		  lp = new LoginPageBO(driver, webActionUtils);
